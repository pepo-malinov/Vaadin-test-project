# Vaadin test app [![Build Status](https://app.travis-ci.com/pepo-malinov/Vaadin-test-project.svg?branch=master)](https://app.travis-ci.com/pepo-malinov/Vaadin-test-project)
