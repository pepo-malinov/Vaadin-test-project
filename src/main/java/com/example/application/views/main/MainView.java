...
public class MainView extends AppLayout {
    ...
    private static Tab[] getAvailableTabs() {
        return new Tab[]{createTab("About", AboutView.class), createTab("Hello World1", HelloWorld1View.class),
                createTab("Master-Detail", MasterDetailView.class), createTab("Card List", CardListView.class),
